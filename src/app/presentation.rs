...
fn builtin_tool_usage_override(name: &str) -> Option<&'static str> {
    match name {
        ...
        "network-log" => Some("network-log [url_contains]"),
        "dialog-accept" => Some("dialog-accept [prompt_text]"),
...
pub(super) fn compact_tool_description(name: &str, description: &str) -> String {
    ...
    match name {
        ...
        "dialog-accept" => "接受当前 JavaScript 弹窗".to_string(),
        "dialog-dismiss" => "关闭当前 JavaScript 弹窗".to_string(),
