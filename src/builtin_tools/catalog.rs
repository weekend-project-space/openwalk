...
pub fn builtin_tool_metadata(name: &str) -> Option<ToolMetadata> {
    ...
    Some(match name {
        ...
        "dialog-accept" => ToolMetadata {
            name: name.to_string(),
            description: "接受当前 JavaScript 弹窗；prompt 弹窗可传入输入文本。".to_string(),
            args: vec![tool_arg(
                "prompt_text",
                "string",
                false,
            ...
            returns: ToolReturn {
                return_type: "boolean".to_string(),
                description: "弹窗成功接受时返回 true。".to_string(),
            },
            examples: vec![
                "openwalk exec dialog-accept".to_string(),
                "openwalk exec dialog-accept hello".to_string(),
            ],
            domains: Vec::new(),
            read_only: false,
            requires_login: false,
        ...
        "dialog-dismiss" => ToolMetadata {
            name: name.to_string(),
            description: "关闭或取消当前 JavaScript 弹窗。".to_string(),
            args: Vec::new(),
            returns: ToolReturn {
                return_type: "boolean".to_string(),
                description: "弹窗成功关闭时返回 true。".to_string(),
            },
            examples: vec!["openwalk exec dialog-dismiss".to_string()],
            domains: Vec::new(),
            read_only: false,
            requires_login: false,
            tags: vec![
